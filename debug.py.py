...
for i in tqdm(range(342)):
    ...
    image.append(imantics.Image.from_path('/home/seeker/Swin-Transformer-Object-Detection/image/image_{}.png'.format(ophys_experiment_id)))
    ...
    ann=imantics.Annotation.from_mask(mask,image[i],imantics.Category('cell'))
